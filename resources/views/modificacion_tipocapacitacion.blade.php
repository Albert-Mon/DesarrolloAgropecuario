    ...
    <div class="card border-primary">
      ...
      <form action="{{route('guardarcambiostipocapacitacion')}}" method = "POST">
      {{csrf_field()}}        


    <div class="row">
  <div class="col-sm-4">
  <input type="text"  name="Id_tipocapacitacion" id="Id_tipocapacitacion" hidden value="{{$consulta ->Id_tipocapacitacion}}" class="form-control"tabindex="5">
  ...
  <input type="text" class="form-control" value="{{$consulta ->nombretipocapacitacion}}" name="nombretipocapacitacion"id="nombretipocapacitacion" placeholder="Nombre de Capacitación">
  ...
  <input type="text" class="form-control" value="{{$consulta ->categoria}}" name="categoria"id="categoria" placeholder="Ganaderia/Pecuaria/Forestal etc.">
  ...
  <input type="text" class="form-control" value="{{$consulta ->descripciontipocapacitacion}}" name="descripciontipocapacitacion"id="descripciontipocapacitacion" placeholder="Descripción.">
  ...
  <input type="date" class="form-control" value="{{$consulta ->fechainicio}}" name="fechainicio"id="fechainicio" required>
  ...
  <input type="date" class="form-control"  value="{{$consulta ->fechafinal}}" name="fechafinal"id="fechafinal" required>
  ...
  <input type="text" class="form-control" value="{{$consulta ->horario}}" name="horario"id="horario" placeholder="Horario">
  ...
  <input type="text" class="form-control"  value="{{$consulta ->lugar}}" name="lugar"id="lugar" placeholder="Lugar de Capacitación">
                                
              <br>
              <a href="{{route('reportetipocapacitacion')}}">
              <button type="button" class="btn btn-secondary"value="cancelar">Cancelar</button></a>

              <button type="submit" class="btn btn-primary"value="guardartipocapacitacion">Guardar</button>
